                ...
                >
                  ...
                  <ul className="list-group list-group-flush">
                    ...
                    {(chapter.lessons || []).map(lesson => (
                      ...
                      <li
                        key={lesson.id}
                        className={`list-group-item list-group-item-action d-flex justify-content-between align-items-center ${currentLesson?.id === lesson.id
                          ? 'active'
                          : ''
                          }`}
              ...
              <div className="card-body">
                ...
                {progress >= 100 && (
                  ...
                  <div className="alert alert-success mt-4">
                    ...
                    <p>
                      Congratulations! You can now view
                      your certificate.
                    </p>
